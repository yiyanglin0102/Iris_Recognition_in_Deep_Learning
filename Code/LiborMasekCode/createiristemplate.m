...
% Transform bmp file into Matlab recognizable image file
eyeimage = imread(eyeimage_filename); 
% Matlab expect .bmp, .jpg and similar format to be transformed into .mat
% Break file-path into parts, path p, file, f, and extension e 
[p,f,e] = fileparts(eyeimage_filename)
savefile = [f,'-houghpara.mat'];
